...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
% function cris_proc_ecmwf_0(sdate, edate)
%
%   Acumulate CrIS data from sdate to edate, add model
%   and compute radiances. This is ALLFOVS! 
%
%   Input:
...
function cris_proc_ecmwf_0(sdate, edate)
  ...
  str_obs1.surfflags 	= 'umz'; 	% Will contain usgs topo (u),
                                        % base model stemp (m), Dan Zhou (z)
  str_obs1.calc 	= '';
  str_obs1.subset 	= '';		% no subset!
  str_obs1.infix 	= '';
