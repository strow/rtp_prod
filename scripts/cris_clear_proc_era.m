...
function cris_clear_proc(sdate, edate)
  ...
  %
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  say(['Setup - ' num2str(Etc_memory(whos))]);
  ...
  %
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  say(['Filename - ' num2str(Etc_memory(whos))]);
  ...
  str_obs1.atm_model 	= 'era';	% Will contain profile information
  str_obs1.surfflags 	= 'udz'; 	% Will contain usgs topo,
                                        % diurnal stemp, D.Zhou's emis.
  str_obs1.calc 	= '';
  ...
  %
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  say(['Make RTP - ' num2str(Etc_memory(whos))]);
  ...
  %
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  say(['Add Profile - ' num2str(Etc_memory(whos))]);
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  %% Do subset, if wanted.
  iclear = find(bitand(prof.iudef(1,:),1));
  ...
  %
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  say(['Saving  - ' num2str(Etc_memory(whos))]);
  ...
  %
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  say(['Calculations  - ' num2str(Etc_memory(whos))]);
    ...
    %[ ht htt pt ptt ] = SartaRun(tempfile, 12);
    %prof.rcalc = pt.rcalc;
    %clear ht htt pt ptt 
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  % Trim and save file
  say(['Saving calcs - ' num2str(Etc_memory(whos))]);

  disp(['Saving data ' output_file_calc]);
  [head hattr prof pattr] = rtptrim(head,hattr,prof,pattr,'parent',output_file_obs1);
