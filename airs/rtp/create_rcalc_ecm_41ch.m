...
bn=basename(f{1});
outfile_cld = [dirname(f{1}) '/cld_ecm_41ch.' bn];
outfile_clr = [dirname(f{1}) '/clr_ecm_41ch.' bn];
...
%  disp(['reading ecm file for: ' datestr(d)])
...
ciwc = prof.ciwc;
cc = prof.cc;
[head,prof] = subset_rtp(head,prof,[],sort([41   54  181  273  317  359  445  449  532  758  903  904 1000 1020 1034 1055 1075 1103 1249 1282 1291 1447 1475 1557 1604 1614 1618 1660 1790 1866 1867 1868 1878 1888 2112 2140 2321 2325 2333 2339 2353]),[]);
prof.clwc = clwc;
prof.ciwc = ciwc;
prof.cc = cc;
