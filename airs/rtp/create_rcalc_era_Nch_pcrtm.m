% basically same as create_rcalc_cld_pcrtm2
% testing 
%   clustcmd -L create_rcalc_era_Nch_pcrtm.m 20020901
%
% when happ
%  clustcmd -q long_contrib -n 8 create_rcalc_era_Nch_pcrtm.m 20020901:now
% or broken up into eg
%  clustcmd -q long_contrib -n 8 create_rcalc_era_Nch_pcrtm.m 20020901:20021231
%
% code piggbacks off whatever file exists (eg cld_era_41ch.airs_ctr*.rtp in example below,
% to put in new cloud calcs for the N channels that already exist
...
for file = list
  infile = file{1}
  outfile = [dirname(file{1}) '/cldsergiopcr_' basename(file{1})]
...
%  toc
  ...
  [h,ha,p1,pa] = rtptrim_pcrtmcloud(h,ha,p1,pa);
