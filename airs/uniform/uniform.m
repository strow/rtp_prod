function [nun, indun]=uniform(freq, rad, calflag, itest, dbtmax, flagmax);
...
% Created: 27 June 2002, Scott Hannon
% Trivial update: 22 Oct 2002 Scott Hannon - change *flg* to *flag*
