...
% Update: 23 Jan 07, S.Hannon - create variant for Feb2006 bad ECMWF files.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[head, prof] = readbadecmwf60_nearest(ecmwffile, gdata.rlat, gdata.rlon);
...
%%% Uncomment to adjust EMCWF surface pressure
