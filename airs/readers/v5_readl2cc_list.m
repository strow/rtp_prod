function [eq_x_tai, f, gdata] = readl2cc_list(fn, iatrack, ixtrack);
...
%
% Output:
%    eq_x_tai = (1x 1) mean time of observations, in hours
%    f  = (nchan x 1) default channel frequencies
...
% Update: 12 Dec 2006, S.Hannon - minor changes for PGE v5: always use
%    default freq, and add dust flag
% Update: 29 May 2008, S.Hannon - add granule number
% Update: 17 Mar 2010, S.Hannon - return eq_x_tai instead of meantime
% Update: 20 Jan 2011, P.Schou - renamed the udef1/udef2 to RetQAFlag and dust_flag
%    added the calnum to the output
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
CalChanSummary = reshape( double(junk), 2378, 1);
%
% Assign NeN_L1B
[junk,s]=hdfsw('readfield',swath_id,'NeN_L1B',[],[],[]);
NeN_L1B = reshape( double(junk), 2378, 1);
...
[raw_calflag, gdata.cstr] = data_to_calnum(meantime, f_default, NeN_L1B, ...
