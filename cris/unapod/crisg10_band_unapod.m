function [radbu] = crisg10_band_unapod(radbpr);

% function [radbu] = crisg10_band_unapod(radbpr);
%
% Convert padded & rolled off Hamming CrIS g10 spectra for one
% of the three bands to unapodized.
%
% Input:
%    radbpr - [1763/1411/1031 x nobs] padded/rolled off Hamming spectra
%
% Output:
...
% Update: 09 Aug 2011, S.Hannon - rename "band_unapod.m" to
%    "crisg10_band_unapod.m"
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
